...
#    print mail_body
    ...
    #发送邮箱用户名/密码
    user = 'wushixin547@126.com'
    password='wushixin547'
    #发送邮箱
    sender='wushixin547@126.com'
    #多个接收邮箱，单个收件人的话，直接是receiver='XXX@126.com'
    receiver=['261229090@qq.com']
    #发送邮件主题
...
#要在163有限设置授权码（即客户端的密码），否则会报535
    msg['From'] = 'wushixin547@126.com <wushixin547@126.com>'
...
#不用绝对路径会报：ImportError: Start directory is not importable: './test_case'
    ...
    #知道测试报告的路径
    test_report_dir=r'C:\Users\neunn\Documents\wushixin\eclipse_job\workspaces\PythonCase\src\Python27\result'
...
#需修改电脑时间为北京时间，且加上休眠时间，否则生成的邮件不会显示测试报告html内容。
#    time.sleep(3)
